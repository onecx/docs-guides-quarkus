...
Now that xref:project-structure.adoc[project structure] is set up for the Onecx Quarkus project, we can configure the k8s operator and extend the project configuration.
