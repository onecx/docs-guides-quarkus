...
[TIP]
The source code of the sample application is located in the documentation repository https://github.com/onecx/docs-guides-quarkus/tree/main/docs/modules/quarkus/examples/quarkus/base/example[Base example]
...
GitHub project configuration is defined in the `.github` directory.
...
For more details of the helm template configuration check the repository of {helm-quarkus-app-url}[{helm-quarkus-app-name}] and the {helm-url}[Helm documentation].
